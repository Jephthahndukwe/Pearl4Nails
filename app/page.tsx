...
export default function Home() {
  ...
  const galleryData = {
    nails: [
      { id: "nails-1", src: "/images/Nail27.png", fallback: "/api/placeholder/300/300?text=Nails1", title: "Beauty Service" },
      { id: "nails-2", src: "/images/Nail16.jpeg", fallback: "/api/placeholder/300/300?text=Nails2", title: "Beauty Service" },
      { id: "nails-3", src: "/images/Nail10.jpeg", fallback: "/api/placeholder/300/300?text=Nails3", title: "Beauty Service" },
      { id: "nails-4", src: "/images/Nail13.jpeg", fallback: "/api/placeholder/300/300?text=Nails4", title: "Beauty Service" }
    ],
    lashes: [
      { id: "lashes-1", src: "/images/Lashextension2.png", fallback: "/api/placeholder/300/300?text=Lashes1", title: "Beauty Service" },
      { id: "lashes-2", src: "/images/Lashextension1.png", fallback: "/api/placeholder/300/300?text=Lashes2", title: "Beauty Service" },
    ],
    makeup: [
      { id: "makeup-1", src: "/images/Makeup1.jpeg", fallback: "/api/placeholder/300/300?text=Makeup1", title: "Beauty Service" },
    ]
  };
