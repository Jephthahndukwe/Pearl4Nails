...
export default function Home() {
  ...
  const galleryData = {
    nails: [
      {
        id: "nails-1",
        src: "/images/Nail27.png",
        fallback: "/api/placeholder/300/300?text=Nails1",
        title: "Beauty Service",
      },
      {
        id: "nails-2",
        src: "/images/Nail16.jpeg",
        fallback: "/api/placeholder/300/300?text=Nails2",
        title: "Beauty Service",
      },
      {
        id: "nails-3",
        src: "/images/Nail10.jpeg",
        fallback: "/api/placeholder/300/300?text=Nails3",
        title: "Beauty Service",
      },
      {
        id: "nails-4",
        src: "/images/Nail13.jpeg",
        fallback: "/api/placeholder/300/300?text=Nails4",
        title: "Beauty Service",
      },
    ],
    lashes: [
      {
        id: "lashes-1",
        src: "/images/Lashextension2.png",
        fallback: "/api/placeholder/300/300?text=Lashes1",
        title: "Beauty Service",
      },
      {
        id: "lashes-2",
        src: "/images/Lashextension1.png",
        fallback: "/api/placeholder/300/300?text=Lashes2",
        title: "Beauty Service",
      },
    ],
    makeup: [
      {
        ...
        fallback: "/api/placeholder/300/300?text=Makeup1",
        title: "Beauty Service",
      },
    ],
  }
          ...
          <div className="container relative z-10 px-4 py-20 md:py-32 mb-[5%]">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Button
                  size="lg"
                  className="bg-white text-pink-500 hover:bg-pink-50 text-lg px-8 rounded-full shadow-lg"
                >
                ...
                <div key={i} className="group relative overflow-hidden rounded-xl aspect-square">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-between p-4">
                    <div className="text-white font-medium">
                      {post.platform === "instagram" ? <p>@pearl4nails</p> : <p>@pearl_4_nails</p>}
                    </div>
                    {post.platform === "instagram" ? (
